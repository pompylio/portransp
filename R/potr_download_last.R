...
#'
#' @examples
#' potr_download_last(opendata = 22, reference = 2021)
#' potr_download_last(opendata = 22, reference = 2021, destfile = "~/")
#' potr_download_last(opendata = 22, reference = 2021, destfile = "~/", filename = "compras")
#' potr_download_last(opendata = "22", reference = "2021")
#' potr_download_last(opendata = "22", reference = "2021", destfile = "~/")
#' potr_download_last(opendata = "22", reference = "2021", destfile = "~/", filename = "compras")
#' potr_download_last(opendata = "compras", reference = "2021")
#' potr_download_last(opendata = "compras", reference = 2021, destfile = "~/")
#' potr_download_last(opendata = "compras", reference = 2021, destfile = "~/", filename = "compras")
#' @export
potr_download_last <- function (opendata, destfile, filename, numref_ignore, ...){
    if (missing(opendata))
